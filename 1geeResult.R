...
dt <- read.csv('c:/Users/lxiong/Downloads/gedi_is1_csv_export_0618_8pm.csv')

#dt <- read.csv('c:/Users/lxiong/Downloads/gedi_is1_csv_export.csv')

#dt <- read.csv('c:/Users/lxiong/Downloads/ee-chart (15).csv')

#colnames(dt) <- c('index', 'is1_values','gedi_rh98', 'geo')
...
result <- result[,c('is1_values','gedi_rh98')]
...
p <- ggplot(result, aes(x = is1_values, y = gedi_rh98)) +
...
height_bins <- cut(result$is1_values, breaks = seq(3.5,60.5))
